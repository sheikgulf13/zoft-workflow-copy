...
export default function CreateFlowModal({ isOpen, onClose }: CreateFlowModalProps) {
  ...
  const [newFlowDisplayName, setNewFlowDisplayName] = useState<string>("Untitled Flow");
  ...
  const handleCreateNamedFlow = async () => {
    ...
    try {
      ...
      toastSuccess("Flow created", `"${flow.name || displayName}" is ready to edit.`);
          ...
          <div className="p-6 space-y-4">
            ...
            <div className="pt-2 flex items-center justify-end gap-3">
              ...
              <button
                ...
                disabled={isLoading !== null || newFlowDisplayName.trim().length === 0}
