...
const variantStyles: Record<ToastVariant, VariantStyle> = {
  success: {
    container: "border border-emerald-200 bg-white text-emerald-900 shadow-lg",
  ...
  error: {
    container: "border border-red-200 bg-white text-red-900 shadow-lg",
    icon: <XCircle className="h-5 w-5 text-red-600" aria-hidden />,
    actionBtn: "text-red-700 hover:bg-red-50 focus-visible:ring-red-300",
  },
  neutral: {
    container: "border border-gray-200 bg-white text-gray-900 shadow-lg",
  ...
  warning: {
    container: "border border-amber-200 bg-white text-amber-900 shadow-lg",
